...
import {updateMorStatusInfo} from "@/service/api/company-info";
...
function createDefaultModel(): Api.Business.BusinessMorInfo {
  return {
    id: '',
    updateType: '',
    remark: '',
...
async function handleSubmit() {
  const {error, response} = await updateMorStatusInfo(model.value);
  if (!error) {
