...
class ModelMixin(db.Model):
    ...
    def to_json(self):
            ...
            if not attr.startswith('_'):
                ...
                if isinstance(value, datetime):
                    ...
                    if camel_case_attr == 'menuCheckStrictly' or camel_case_attr == 'deptCheckStrictly':
                        ...
                        json_data[camel_case_attr] = '' if value is None or value == '' else url_for('static',
                                                                                                     filename=value,
                                                                                                     _external=True)
                    else:
        ...
        if self.__tablename__ == 'gen_table_column':
            ...
            json_data['superColumn'] = True if 'javaField' in json_data and json_data['javaField'] in {"createBy",
                                                                                                       "createTime",
                                                                                                       "updateBy",
                                                                                                       "updateTime",
                                                                                                       "remark",
                                                                                                       ...
                                                                                                       "parentId",
                                                                                                       "orderNum",
                                                                                                       "ancestors"} else False
            json_data['usableColumn'] = True if 'javaField' in json_data and json_data['javaField'] in {"parentId",
                                                                                                        "orderNum",
                                                                                                        "remark"} else False
        return json_data
